...
public class Ball extends BaseObject {
    ...
    public Ball(final double x, final double y, final double speed, final double direction) {
        super(x, y, 1);
    ...
    /**
     * Устанавливаем новое направление движения. Тут же вычисляем и новый вектор.
    ...
    /**
     * Проверяем не улетел ли шарик за стенку. Если да - отражаем его.
     */
    void checkRebound(final int minx, final int maxx, final int miny, final int maxy) {
        if (x < minx) {
            x = minx + (minx - x);
            dx = -dx;
        }
